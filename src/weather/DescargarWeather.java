 ...
 * 
 */
public class DescargarWeather extends AsyncTask<Bundle, Void, String> {
	...
	protected void onPostExecute(String cadena) {
		...
		try {
			...
			new GetWeatherYahoo().execute(bund);
//			this.bund.putStringArrayList("titulares", titulares);
//			new HablaNoticias().execute(bund);
